...
describe('colony Phase 0 playtest', () => {
  it.skip('a colony given farms survives the run and produces food', () => {
  ...
  it.skip('without any farms the colony eventually starves (negative control)', () => {
    const s = createColony(2024);
  ...
  it.skip('survives into winter with a heated room and clothing buffer', () => {
